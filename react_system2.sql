...
CREATE TABLE `blog_list`  (
  ...
  `config` mediumtext CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL,
  `createAt` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `updateAt` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `user_id`(`user_id`) USING BTREE,
  CONSTRAINT `blog_list_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE = InnoDB AUTO_INCREMENT = 2 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of blog_list
-- ----------------------------
INSERT INTO `blog_list` VALUES (7, 17, '测试', '感悟', '[{\"type\":\"title\",\"value\":\"怎么有人这么蠢\",\"title\":\"次级标题\"}]', '2022-11-06 17:54:17', '2022-11-06 17:54:17');
...
-- ----------------------------
-- Table structure for jurisdiction_list
-- ----------------------------
DROP TABLE IF EXISTS `jurisdiction_list`;
CREATE TABLE `jurisdiction_list`  (
  `id` int NOT NULL AUTO_INCREMENT,
...
-- ----------------------------
-- Records of jurisdiction_list
-- ----------------------------
INSERT INTO `jurisdiction_list` VALUES (1, 'test,test2,master,wangdage', '2022-11-06 18:11:00');
...
INSERT INTO `user` VALUES (17, 'master', '4ac4cb7d5e5d57e178bf533c738e0546', '2022-11-06 16:58:21', '2022-11-06 16:58:21');
INSERT INTO `user` VALUES (18, 'wangdage', '396ca1b5f271f91203838cdeed9f0498', '2022-11-06 18:09:47', '2022-11-06 18:09:47');
INSERT INTO `user` VALUES (19, 'test', 'cc03e747a6afbbcbf8be7668acfebee5', '2022-11-06 18:09:55', '2022-11-06 18:09:55');
