...
>
  ...
  <cover-view class="diy-icon" bindtap="moveTolocation">
    <cover-image class="pos-icon" src="http://hh-oss-picture.miyapay.com/box/bd742b2365905561ba25638f24fedd89.png"></cover-image>
  </cover-view>
</map>
```
...
<span style="backGround: #efe0b9">Demo.jso</span>
...
dos() {
  this.data.covers.push({
    ...
    width: 30,
    height: 30,
    iconPath: 'http://hh-oss-picture.miyapay.com/box/c054db31b0f0bfe129d358067515b810.png', // 显示的图标
    zIndex: 100, // 层级
    callout: {
      ...this.data.callout,
...
wx.cloud.callFunction({
  config:{ env: 'whole-process-expe-5dwwr3132132d' }, // 环境ID
...
:turtle: 核心在于，点击目标时，有可能其上没有需要的属性，所以内部元素也得加上相应属性。
